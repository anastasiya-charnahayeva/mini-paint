<template>
  <div class="my-8 container m-auto text-xl">
    <h1 class="text-xl font-bold text-center">Images Feed</h1>
    ...
    <div
      ...
      :key="idx"
      class="b-2 my-8 container m-auto text-xl"
    >
      <img
...
<script lang="ts" setup>
  ...
  const { images, addImage, getImages, filterByUser, chosenUser } = imagesStore;
